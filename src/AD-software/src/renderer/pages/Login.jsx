            ...
            <div className={sty.loginBox}>
                ...
                >
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, message: 'Please enter your phone number!' }, {
                                validator(_, value) {
                                    ...
                                    return Promise.reject(new Error('Please enter a legal phoen number!'));
                                }
                            }]}
                        >
                            <Input />
                    ...
                    {!isLogin && (
                        <Form.Item
                            label="E-mail"
                            name="mail"
                            rules={[{ required: true, message: 'Please enter your E-mail!' }, { type: 'email', message: 'Please enter a legal E-mail!' }]}
                        >
                            <Input />
                        </Form.Item>
                    )}
                ...
                <div style={{
                    ...
                    <Button onClick={() => {
                        ...
                        setIsLogin(!isLogin)
                    }} type='link'>{isLogin ? 'No account yet? Register！' : 'Already registered? Login!'}</Button>
                </div>
