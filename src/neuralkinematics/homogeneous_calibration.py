...
for lo in (test_subs):
    ...
    plt.legend()
    plt.show()
    ''' Freeze up to the last two layers of the generator'''
    for layer in net.generator.layers[:-2]:
    ...
    plt.savefig(f'results/png/finetuning_gan_s_{lo:02d}_1_0.png')
    plt.show()
    plt.close()
